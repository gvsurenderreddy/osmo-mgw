...
/*! \brief send RTP packet through OSMUX connection
...
/*! \brief enable OSXMUX circuit for a specified connection
...
/*! \brief disable OSXMUX circuit for a specified connection
 *  \param[in] conn connection to disable */
...
/*! \brief relase OSXMUX cid, that had been allocated to this connection
...
/*! \brief allocate OSXMUX cid to connection
...
/*! \brief send RTP dummy packet to OSMUX connection port
...
/*! \brief bsc-nat allocates/releases the OSMUX cids (Circuit IDs) */
static uint8_t osmux_cid_bitmap[(OSMUX_CID_MAX + 1) / 8];

/*! \brief count the number of taken OSMUX cids
...
/*! \brief put back a no longer used OSMUX cid
